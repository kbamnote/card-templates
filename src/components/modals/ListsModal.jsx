  ...
  const handleDelete = async () => {
    try {
      switch (deleteItem.type) {
        case 'service':
          await serviceDelete(deleteItem.id);
          break;
        case 'gallery':
          await galleryDelete(deleteItem.id);
          break;
        case 'product':
          await productDelete(deleteItem.id);
          break;
        case 'testimonial':
          await testimonialDelete(deleteItem.id);
          break;
        default:
          return;
      }
                    ...
                    {services.map(service => (
                      <div key={service._id} className="bg-zinc-800 p-4 rounded-lg flex justify-between items-center">
                        ...
                        <div className="flex space-x-2 ml-3">
                          ...
                          <button 
                            onClick={() => openDeleteModal('service', service._id, service.title)}
                    ...
                    {galleryItems.map(item => (
                      <div key={item._id} className="bg-zinc-800 p-4 rounded-lg flex justify-between items-center">
                        ...
                        <div className="flex space-x-2 ml-3">
                          ...
                          <button 
                            onClick={() => openDeleteModal('gallery', item._id, item.caption || 'Gallery Item')}
                            className="text-red-400 hover:text-red-300 text-sm"
                          >
                            Delete
                          </button>
                    ...
                    {products.map(product => (
                      <div key={product._id} className="bg-zinc-800 p-4 rounded-lg flex justify-between items-center">
                        ...
                        <div className="flex space-x-2 ml-3">
                          ...
                          <button 
                            onClick={() => openDeleteModal('product', product._id, product.productName)}
                            className="text-red-400 hover:text-red-300 text-sm"
                          >
                            Delete
                          </button>
                    ...
                    {testimonials.map(testimonial => (
                      <div key={testimonial._id} className="bg-zinc-800 p-4 rounded-lg flex justify-between items-center">
                        ...
                        <div className="flex space-x-2 ml-3">
                          ...
                          <button 
                            onClick={() => openDeleteModal('testimonial', testimonial._id, testimonial.testimonialName)}
                            className="text-red-400 hover:text-red-300 text-sm"
                          >
                            Delete
                          </button>
