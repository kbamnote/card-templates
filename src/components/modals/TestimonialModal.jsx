...
const TestimonialModal = ({ isOpen, onClose, testimonialData, onSave, isEditing, onDelete }) => {
  const [formData, setFormData] = useState({
    testimonialName: '',
    feedback: ''
  });

  // Initialize form data when testimonialData changes
  useEffect(() => {
    if (testimonialData && isEditing) {
      setFormData({
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    onSave(formData, isEditing ? testimonialData?._id : null);
  };
