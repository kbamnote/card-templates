...
function PhotographerTemplate({ profileData }) {
  const accent = profileData?.accentColor || '#8e44ad'

  // Use profile data or fallback to defaults
  const services = profileData?.services || [
    { title: 'Portrait Sessions', desc: 'Professional headshots and individual portraits.' },
    { title: 'Event Coverage', desc: 'Weddings, parties, and special occasions.' },
    { title: 'Commercial Photography', desc: 'Product and business photography.' },
  ]

  const gallery = profileData?.gallery || [
    { src: 'https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/photo1/800/600' },
    { src: 'https://images.pexels.com/photos/1181244/pexels-photo-1181244.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/photo2/800/600' },
    { src: 'https://images.pexels.com/photos/1181272/pexels-photo-1181272.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/photo3/800/600' },
    { src: 'https://images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/photo4/800/600' },
  ]

  const products = profileData?.products || [
    { name: 'Portrait Session', price: '$199.00', img: { src: 'https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/photo5/800/600' } },
    { name: 'Wedding Package', price: '$899.00', img: { src: 'https://images.pexels.com/photos/1181244/pexels-photo-1181244.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/photo6/800/600' } },
  ]
    ...
    : [
        {
          name: 'Sarah Johnson',
          role: 'Wedding Client',
          feedback: 'Captured our special day perfectly. The photos exceeded our expectations!',
          rating: 5
        }
      ];
  ...
  return (
    <div className="min-h-screen bg-[#f9f4ff] text-[#2c0a3a]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <section className="relative overflow-hidden rounded-2xl">
          <img
            ...
            onError={(e)=>{e.currentTarget.src='https://picsum.photos/seed/photohero/1600/400'}}
        ...
        <section className="mt-4">
          <div className="bg-white rounded-2xl p-4 shadow flex items-center gap-4">
            <img
              ...
              onError={(e)=>{e.currentTarget.src='https://picsum.photos/seed/photoprofile/200/200'}}
              alt="Photographer profile"
              className="w-16 h-16 rounded-full object-cover"
            />
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <h1 className="text-xl sm:text-2xl font-semibold">{profileData?.name || "Alex Morgan"}</h1>
                {profileData?.logoImg && (
                  <img 
              ...
              <p className="text-[#5c6b80]">{profileData?.profession || "Professional Photographer • Portraits & Events"}</p>
        ...
        <section className="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          <div className="rounded-xl bg-white p-4 shadow">
            ...
            <p className="font-medium break-all">{profileData?.email || "alex@photography.com"}</p>
          </div>
          <div className="rounded-xl bg-white p-4 shadow">
            <p className="text-sm text-[#5c6b80]">Phone</p>
            <p className="font-medium break-all">{profileData?.phone1 || "+1 (555) 234-7890"}</p>
          </div>
          <div className="rounded-xl bg-white p-4 shadow">
            <p className="text-sm text-[#5c6b80]">Website</p>
            <p className="font-medium break-all">{profileData?.websiteLink || "alexmorgan.photography"}</p>
          </div>
          <div className="rounded-xl bg-white p-4 shadow">
            <p className="text-sm text-[#5c6b80]">Location</p>
            <p className="font-medium break-all">{profileData?.location || "Los Angeles, CA"}</p>
          </div>
        </section>
