    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-50 text-gray-900">
      ...
      <section className="relative py-8 md:py-10 px-4 md:px-6 text-center">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-2xl md:text-3xl font-bold mt-4 md:mt-6">{profileData?.name || "Alex Johnson"}</h1>
          <p className="text-blue-600 font-medium mt-1 md:mt-2 text-sm md:text-base">{profileData?.profession || "Senior Software Engineer & Tech Consultant"}</p>
          <p className="text-gray-600 mt-2 md:mt-3 text-sm md:text-base max-w-md mx-auto">Building scalable solutions for forward-thinking businesses with over 10 years of experience.</p>
      ...
      <section className="py-4 md:py-6 px-4 md:px-6 bg-white">
        <div className="grid grid-cols-4 gap-2 md:gap-4 text-center">
          <div>
            <p className="text-lg md:text-2xl font-bold text-blue-600">150+</p>
            <p className="text-xs text-gray-500 mt-1">Projects</p>
          </div>
          <div>
            <p className="text-lg md:text-2xl font-bold text-blue-600">98%</p>
          ...
          <div>
            <p className="text-lg md:text-2xl font-bold text-blue-600">10+</p>
      ...
      <section className="py-6 md:py-8 px-4 md:px-6 bg-blue-50">
        <h2 className="text-xl md:text-2xl font-bold mb-4">My Services</h2>
            ...
            <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-sm">
              ...
              >
                <div className="flex items-center">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center mr-3 md:mr-4" style={{ backgroundColor: `${accent}20` }}>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-xs md:text-sm mt-1">{service.desc}</p>
                  </div>
                </div>
                <svg className="w-4 h-4 md:w-5 md:h-5 text-gray-500 transform transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path>
                </svg>
              </label>
              <div className="px-4 md:px-5 pb-4 md:pb-5 max-h-0 overflow-hidden transition-all duration-300">
                <p className="text-gray-600 text-xs md:text-sm pt-2 border-t border-gray-100 mt-2">
                ...
                <button 
                  className="mt-3 md:mt-4 w-full py-2 rounded-lg font-medium text-sm"
          ...
          {gallery.map((item, index) => (
            ...
            >
              ...
              <div className="p-3 md:p-4">
                <h3 className="font-bold text-sm md:text-base">Project Title {index+1}</h3>
                <p className="text-gray-600 text-xs md:text-sm mt-1">Web Development • React • Node.js</p>
                <div className="flex mt-2 md:mt-3 flex-wrap">
                  <span className="px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded mr-2 mb-1">React</span>
                  <span className="px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded mr-2 mb-1">Node.js</span>
                  <span className="px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded mb-1">MongoDB</span>
                </div>
              </div>
            </div>
          ))}
      ...
      <section className="py-6 md:py-8 px-4 md:px-6 bg-blue-50">
        <h2 className="text-xl md:text-2xl font-bold mb-4">Client Testimonials</h2>
        <div className="space-y-4 md:space-y-6">
            ...
            <div key={index} className="bg-white rounded-2xl p-4 md:p-6 shadow-sm">
              <div className="flex items-center">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-blue-100 flex items-center justify-center">
                  <span className="font-bold text-blue-600 text-sm md:text-base">MR</span>
                </div>
              ...
              <p className="mt-3 md:mt-4 text-gray-600 text-sm">"{testimonial.feedback}"</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-6 md:py-8 px-4 md:px-6 bg-gradient-to-r from-blue-500 to-indigo-600 text-white">
        <h2 className="text-xl md:text-2xl font-bold mb-2">Let's Work Together</h2>
        <p className="text-blue-100 text-sm mb-4">Schedule a free consultation to discuss your project</p>
        ...
        <div className="mt-4 md:mt-6 grid grid-cols-1 gap-2 md:gap-3">
          <div className="flex items-center bg-white/20 p-2 md:p-3 rounded-lg">
            ...
            <span className="text-sm">{profileData?.email || "hello@techsolutionspro.com"}</span>
          </div>
          <div className="flex items-center bg-white/20 p-2 md:p-3 rounded-lg">
            <Phone size={16} className="md:size-18 mr-2 md:mr-3" />
            <span className="text-sm">{profileData?.phone1 || "+1 (555) 345-6789"}</span>
          </div>
          <div className="flex items-center bg-white/20 p-2 md:p-3 rounded-lg">
