...
function RealEstateAgentTemplate({ profileData }) {
  const accent = profileData?.accentColor || '#3498db'

  // Use profile data or fallback to defaults
  const services = profileData?.services || [
    { title: 'Property Sales', desc: 'Buying and selling residential and commercial properties.' },
    { title: 'Property Management', desc: 'Full-service property management solutions.' },
    { title: 'Market Analysis', desc: 'Comprehensive property valuation and market insights.' },
  ]

  const gallery = profileData?.gallery || [
    { src: 'https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/realestate1/800/600' },
    { src: 'https://images.pexels.com/photos/1181244/pexels-photo-1181244.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/realestate2/800/600' },
    { src: 'https://images.pexels.com/photos/1181272/pexels-photo-1181272.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/realestate3/800/600' },
    { src: 'https://images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/realestate4/800/600' },
  ]

  const products = profileData?.products || [
    { name: 'Property Listing', price: 'Commission-based', img: { src: 'https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/realestate5/800/600' } },
    { name: 'Market Report', price: '$99.00', img: { src: 'https://images.pexels.com/photos/1181244/pexels-photo-1181244.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/realestate6/800/600' } },
  ]
    ...
    : [
        {
          name: 'Robert Chen',
          role: 'Home Buyer',
          feedback: 'Found our dream home with expert guidance. Professional and knowledgeable throughout the process.',
          rating: 5
        }
      ];
  ...
  return (
    <div className="min-h-screen bg-[#f4f9ff] text-[#0a253a]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <section className="relative overflow-hidden rounded-2xl">
          <img
            ...
            onError={(e)=>{e.currentTarget.src='https://picsum.photos/seed/realestatehero/1600/400'}}
        ...
        <section className="mt-4">
          <div className="bg-white rounded-2xl p-4 shadow flex items-center gap-4">
            <img
              ...
              onError={(e)=>{e.currentTarget.src='https://picsum.photos/seed/realestateprofile/200/200'}}
              alt="Real estate agent profile"
              className="w-16 h-16 rounded-full object-cover"
            />
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <h1 className="text-xl sm:text-2xl font-semibold">{profileData?.name || "Sarah Williams"}</h1>
                {profileData?.logoImg && (
                  <img 
              ...
              <p className="text-[#5c6b80]">{profileData?.profession || "Licensed Real Estate Agent • Residential & Commercial"}</p>
        ...
        <section className="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          <div className="rounded-xl bg-white p-4 shadow">
            ...
            <p className="font-medium break-all">{profileData?.email || "sarah@realestatepro.com"}</p>
          </div>
          <div className="rounded-xl bg-white p-4 shadow">
            <p className="text-sm text-[#5c6b80]">Phone</p>
            <p className="font-medium break-all">{profileData?.phone1 || "+1 (555) 345-6789"}</p>
          </div>
          <div className="rounded-xl bg-white p-4 shadow">
            <p className="text-sm text-[#5c6b80]">Website</p>
            <p className="font-medium break-all">{profileData?.websiteLink || "sarahwilliams.realestate"}</p>
          </div>
          <div className="rounded-xl bg-white p-4 shadow">
            <p className="text-sm text-[#5c6b80]">Location</p>
            <p className="font-medium break-all">{profileData?.location || "Austin, TX"}</p>
          </div>
        </section>
