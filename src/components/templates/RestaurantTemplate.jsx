...
function RestaurantTemplate({ profileData }) {
  const accent = profileData?.accentColor || '#e74c3c'

  // Use profile data or fallback to defaults
  const services = profileData?.services || [
    { title: 'Fine Dining', desc: 'Gourmet meals prepared by expert chefs.' },
    { title: 'Private Events', desc: 'Birthday parties, corporate events, and weddings.' },
    { title: 'Catering', desc: 'Professional catering for any occasion.' },
  ]

  const gallery = profileData?.gallery || [
    { src: 'https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/rest1/800/600' },
    { src: 'https://images.pexels.com/photos/1181244/pexels-photo-1181244.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/rest2/800/600' },
    { src: 'https://images.pexels.com/photos/1181272/pexels-photo-1181272.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/rest3/800/600' },
    { src: 'https://images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/rest4/800/600' },
  ]

  const products = profileData?.products || [
    { name: 'Chef\'s Tasting Menu', price: '$89.00', img: { src: 'https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/rest5/800/600' } },
    { name: 'Wine Pairing', price: '$45.00', img: { src: 'https://images.pexels.com/photos/1181244/pexels-photo-1181244.jpeg?auto=compress&cs=tinysrgb&w=1200', fallback: 'https://picsum.photos/seed/rest6/800/600' } },
  ]
    ...
    : [
        {
          ...
          role: 'Food Critic',
          feedback: 'Exceptional cuisine and impeccable service. A dining experience to remember.',
          rating: 5
        }
      ];
  ...
  return (
    <div className="min-h-screen bg-[#fff9f9] text-[#3a0a0a]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <section className="relative overflow-hidden rounded-2xl">
          <img
            ...
            onError={(e)=>{e.currentTarget.src='https://picsum.photos/seed/resthero/1600/400'}}
        ...
        <section className="mt-4">
          <div className="bg-white rounded-2xl p-4 shadow flex items-center gap-4">
            <img
              ...
              onError={(e)=>{e.currentTarget.src='https://picsum.photos/seed/restprofile/200/200'}}
              alt="Restaurant profile"
              className="w-16 h-16 rounded-full object-cover"
            />
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <h1 className="text-xl sm:text-2xl font-semibold">{profileData?.name || "Bella Vista Restaurant"}</h1>
                {profileData?.logoImg && (
                  <img 
              ...
              <p className="text-[#5c6b80]">{profileData?.profession || "Fine Dining Restaurant • Italian Cuisine"}</p>
        ...
        <section className="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
          <div className="rounded-xl bg-white p-4 shadow">
            ...
            <p className="font-medium break-all">{profileData?.email || "reservations@bellavista.com"}</p>
          </div>
          <div className="rounded-xl bg-white p-4 shadow">
            <p className="text-sm text-[#5c6b80]">Phone</p>
            <p className="font-medium break-all">{profileData?.phone1 || "+1 (555) 987-3421"}</p>
          </div>
          <div className="rounded-xl bg-white p-4 shadow">
            <p className="text-sm text-[#5c6b80]">Website</p>
            <p className="font-medium break-all">{profileData?.websiteLink || "bellavista.restaurant"}</p>
          </div>
          <div className="rounded-xl bg-white p-4 shadow">
            <p className="text-sm text-[#5c6b80]">Location</p>
            <p className="font-medium break-all">{profileData?.location || "New York, NY"}</p>
          </div>
        </section>
